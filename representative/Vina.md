...
<div class="project-block">
  ...
  <div class="paper-section">
    ...
    <ul>
      <li><strong>Breaking the BRAM Wall: Scalable Vina FPGA Acceleration via Distributed Grid Storage and Cross-Board Long-Ring Pipelines</strong><br><em>DATE, 2026</em></li>
